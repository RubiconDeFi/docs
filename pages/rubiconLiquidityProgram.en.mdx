...
This page details the current structure and benefits of the Rubicon Liquidity Program. **This program is designed to boost the profitability of liquidity providers and market makers on Rubicon.** The program is designed to incentivize liquidity providers through monthly fee rebates. For any questions or further information, please reach out to us via contact [at] rubicon [dot] finance (email) or our [Discord](https://discord.com/invite/E7pS24J).
...
- **Email**: contact [at] rubicon [dot] finance
