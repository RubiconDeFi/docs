---
title: Rubicon | Ayuda de Mercado
pageTitle: Ayuda de Mercado
description: contratos de creación de mercado de alta frecuencia en cadena y funcionalidad para Rubicon
---
...
- estrategaRebalanceFunds
  - Función opcional para usar un lugar de liquidez externo para arbitrar o reequilibrar fondos a través de