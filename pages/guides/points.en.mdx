...
| --------------- | -------------------------------------------- | --------------- | --------------- |
| Swap or Trade on Rubicon   |  OP (ARB, ETH, BASE, and MATIC 🔜) | Any time | USD Volume * (1 + (-0.5)) | 
| Fill a Trade on Rubicon   | OP (ARB, ETH, BASE, and MATIC 🔜) | Any time | USD Volume * (1 + (-0.9)) |


## Likely Future Additions ({POINTS_LEADERBOARD_VERSION})
Potential and expected future additions of actions:
- Expansion of the v0 Points system to all supported networks with varying multipliers. We plan to launch on 
