...
| Goal  | Endpoint                                      |
| --------------- | -------------------------------------------- |
| GET Open Orders (All networks)   | `https://gladius.rubicon.finance/dutch-auction/order/dutch-auction/orders` |
| GET Open Orders (Specific Pair [Directional], Order Status, and Network)   | `https://gladius.rubicon.finance/dutch-auction/order/dutch-auction/orders?chainId=${chainId}&orderStatus=open&buyToken=${quote.address}&sellToken=${token.address}` |
