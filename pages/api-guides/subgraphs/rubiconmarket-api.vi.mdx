---
description: Tổng quan Về Các thực thể Chính Của RubiconMarket subgraph, sự kiện hợp đồng
  xử lý, và các truy vấn ví dụ cho một loạt các trường hợp sử dụng.
---
