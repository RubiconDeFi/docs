...
Follow this [guide](/guides/trade/adding-a-trading-pair) to add a new token/trading pair **locally** on the App, keep in mind liquidity can be low on new trading pairs.
